...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light  mt-3 ">
  		<div class="container bg-dark py-1 rounded">
    		...
    		<a class="navbar-brand bg-white text-dark rounded px-4" href="SearchStaff.jsp">search and update </a>
...
<br/>
    ...
    <div class="container ">
        ...
        <form method="post" action="staff">
            <label for="staffId">Staff ID:    </label>
            <input type="text" readonly class="form-control" id="staffId" name="staffId" value="${staff.staffId}"/>
            <br/>
            <br/>
