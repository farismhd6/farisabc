...
<div class="container-fluid">
    <nav class="navbar navbar-expand-lg navbar-light  mt-3 ">
  		<div class="container bg-dark py-1 rounded">
    		...
    		<a class="navbar-brand bg-white text-dark rounded px-4" href="AddAppointment.jsp">Add </a>
  		</div>
	</nav>
    ...
    <div class="row">
        ...
        <form method="post" action="appointment">
            ...
            <div class="row justify-content-center">
    			<div class="col-auto" >
            		<button class="btn btn-primary" type="submit" class="btn btn-primary" style="width: 200px">Register</button>
    			</div>
  			</div>
        </form>
    </div>
