  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin:0 50px;">
      <div class="navbar-nav" style="#ffff">
        <a class="nav-link active mx-0 mx-md-3 fs-6" aria-current="page" href="AdminDashboard.jsp">Home</a>
        <a class="nav-link mx-0 mx-md-3  fs-6" href="patient.jsp">Manage Patient</a>
        <a class="nav-link mx-0 mx-md-3 fs-6" href="Staff.jsp">Manage Staff</a>
